  ...
  const renderCurrentPage = () => {
    ...
    switch (route) {
      ...
      case '/management/uploads':
        return <V2ComingSoonPage featureName="Management & Assets" onNavigate={handleNavigate} />;
      case '/finance':
        return <FinancePage />;
      case '/customers':
      ...
      case '/engineering':
      case '/product-tech':
        return <V2ComingSoonPage featureName="Product & Technology" onNavigate={handleNavigate} />;
      case '/projects':
        return <ProjectsPage />;
      case '/tasks':
        return <TasksPage />;
